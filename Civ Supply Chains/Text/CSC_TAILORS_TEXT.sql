...
VALUES
    ...
    ('en_US', 'LOC_BUILDING_CSC_TAILORS_TEXTILE_WORKSHOP_DESCRIPTION', '+1 [ICON_Culture] Culture from each adjacent [ICON_CSC_BASE] Base Materials improvement, in exchange for +1 [ICON_Production] Production and +1 [ICON_Gold] Gold.[NEWLINE]+1 [ICON_Production] Production and +1 [ICON_Gold] Gold from each adjacent Lighthouse, and +1 [ICON_Production] Production in return.[NEWLINE]+1 [ICON_Production] Production and +1 [ICON_Gold] Gold from the local Tailor and Fashion House, in exchange for +1 [ICON_Culture] Culture.[NEWLINE][NEWLINE]At Naval Tradition, a supplied Textile Workshop establishes a {LOC_BUILDING_CSC_TAILORS_STAGE_2_SERVICE_NAME} in an adjacent Harbor with a Lighthouse.'),
    ('en_US', 'LOC_BUILDING_CSC_TAILORS_TAILOR_NAME', 'Tailor'),
    ('en_US', 'LOC_BUILDING_CSC_TAILORS_TAILOR_DESCRIPTION', '+1 [ICON_Culture] Culture from the local Textile Workshop, in exchange for +1 [ICON_Production] Production and +1 [ICON_Gold] Gold.[NEWLINE]+0.1 [ICON_Production] Production and +0.1 [ICON_Gold] Gold per [ICON_Citizen] Citizen from each adjacent Temple or Market, in exchange for +0.1 [ICON_Culture] Culture per [ICON_Citizen] Citizen to the customer city.[NEWLINE]+1 [ICON_Culture] Culture bonus to trade routes to the city, in exchange for +1 [ICON_Production] Production and +1 [ICON_Gold] Gold to the Quarter, if the origin city does not have a Tailors'' Quarter. +1 [ICON_Amenities] Amenity to the origin city.[NEWLINE][NEWLINE]At Divine Right, a supplied Tailor establishes a {LOC_BUILDING_CSC_TAILORS_STAGE_3_SERVICE_NAME} in an adjacent Holy Site with a Temple.'),
    ...
    ('en_US', 'LOC_PEDIA_BUILDINGS_PAGE_BUILDING_CSC_TAILORS_TEXTILE_WORKSHOP_CHAPTER_CSCHAIN_TITLE', 'Supply Chain'),
    ('en_US', 'LOC_PEDIA_BUILDINGS_PAGE_BUILDING_CSC_TAILORS_TEXTILE_WORKSHOP_CHAPTER_CSCHAIN_PARA_1', 'The Textile Workshop receives Culture from adjacent Base Materials improvements while returning Production and Gold, exchanges yields with Lighthouses and later local Tailors buildings, and can establish a Dockmaster service.'),
    ('en_US', 'LOC_PEDIA_BUILDINGS_PAGE_BUILDING_CSC_TAILORS_TEXTILE_WORKSHOP_CHAPTER_HISTORY_TITLE', 'History'),
    ('en_US', 'LOC_PEDIA_BUILDINGS_PAGE_BUILDING_CSC_TAILORS_TEXTILE_WORKSHOP_CHAPTER_HISTORY_PARA_1', 'Textile workshops combined specialized tools and skilled labor to prepare fibres, spin thread and weave cloth. Their output linked rural producers to urban merchants, shipyards and markets, making the workshop an early hinge between material supply and commercial life.'),
