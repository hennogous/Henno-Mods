...
(   'en_US',    'LOC_BUILDING_CSC_BAKERS_WATER_MILL_DESCRIPTION',       '+1 [ICON_Food] Food from each adjacent Base Materials improvement, in exchange for +1 [ICON_Production] Production and +1 [ICON_Gold] Gold.[NEWLINE]+1 [ICON_Production] Production and +1 [ICON_Gold] Gold from the local Bakery and Café, in exchange for +1 [ICON_Food] Food.[NEWLINE]+1 [ICON_Production] Production and +1 [ICON_Gold] Gold from an adjacent Granary, in exchange for +1 [ICON_Food] Food.[NEWLINE]+1 [ICON_Food] Food bonus to [ICON_TradeRoute] Trade Routes to the city, in exchange for +1 [ICON_Production] Production and +1 [ICON_Gold] Gold to the Quarter, if the origin city does not have a Bakers'' Quarter.[NEWLINE][NEWLINE]At Feudalism, a supplied Water Mill establishes a {LOC_BUILDING_CSC_BAKERS_STAGE_2_SERVICE_NAME} service in an adjacent City Center with a Granary.'    ),

(   'en_US',    'LOC_BUILDING_CSC_BAKERS_WIND_MILL_NAME',               'Wind Mill'    ),
(   'en_US',    'LOC_BUILDING_CSC_BAKERS_WIND_MILL_DESCRIPTION',        '+1 [ICON_Food] Food from each adjacent Base Materials improvement, in exchange for +1 [ICON_Production] Production and +1 [ICON_Gold] Gold.[NEWLINE]+1 [ICON_Production] Production and +1 [ICON_Gold] Gold from the local Bakery and Café, in exchange for +1 [ICON_Food] Food.[NEWLINE]+1 [ICON_Production] Production and +1 [ICON_Gold] Gold from an adjacent Granary, in exchange for +1 [ICON_Food] Food.[NEWLINE]+1 [ICON_Food] Food bonus to [ICON_TradeRoute] Trade Routes to the city, in exchange for +1 [ICON_Production] Production and +1 [ICON_Gold] Gold to the Quarter, if the origin city does not have a Bakers'' Quarter.[NEWLINE][NEWLINE]At Feudalism, a supplied Wind Mill can establish a {LOC_BUILDING_CSC_BAKERS_STAGE_2_SERVICE_NAME} service in an adjacent City Center with a Granary.'    ),

(   'en_US',    'LOC_BUILDING_CSC_BAKERS_BAKERY_NAME',                  'Bakery'    ),
(   'en_US',    'LOC_BUILDING_CSC_BAKERS_BAKERY_DESCRIPTION',           '+1 [ICON_Food] Food from the local Water Mill or Wind Mill, in exchange for +1 [ICON_Production] Production and +1 [ICON_Gold] Gold.[NEWLINE]+1 [ICON_Citizen] Citizen slot, +2 [ICON_Food] Food to [ICON_Citizen] Citizens in the Quarter.[NEWLINE]+1 [ICON_Amenities] Amenity in the city.[NEWLINE]+0.1 [ICON_Production] Production and +0.1 [ICON_Gold] Gold per [ICON_Citizen] Citizen from each adjacent Market, in exchange for +0.1 [ICON_Food] Food per [ICON_Citizen] Citizen to the Market city.[NEWLINE]+1 [ICON_Food] Food bonus to [ICON_TradeRoute] Trade Routes to the city, in exchange for +1 [ICON_Gold] Gold to the Quarter, if the origin city does not have a Bakers'' Quarter.[NEWLINE][NEWLINE]At Medieval Faires, a supplied Bakery can establish an {LOC_BUILDING_CSC_BAKERS_STAGE_3_SERVICE_NAME} service in an adjacent Commercial Hub with a Market.'    ),

(   'en_US',    'LOC_BUILDING_CSC_BAKERS_CAFE_NAME',                    'Café'    ),
(   'en_US',    'LOC_BUILDING_CSC_BAKERS_CAFE_DESCRIPTION',             '+1 [ICON_Food] Food from the local Water Mill or Wind Mill, in exchange for +1 [ICON_Production] Production and +1 [ICON_Gold] Gold.[NEWLINE]+1 [ICON_Food] Food from each adjacent Specialty Materials improvement, in exchange for +1 [ICON_Production] Production.[NEWLINE]+1 [ICON_Citizen] Citizen slot, +1 [ICON_Food] Food and +1 [ICON_Culture] Culture to [ICON_Citizen] Citizens in the Quarter.[NEWLINE]+1 [ICON_Amenities] Amenity to all cities within 6 tiles.[NEWLINE]+1 [ICON_Culture] Culture to each adjacent Zoo and Ferris Wheel for every 5 [ICON_Citizen] Citizens in the city, in exchange for +1 [ICON_Production] Production and +1 [ICON_Gold] Gold to the Café.[NEWLINE]+1 [ICON_Food] Food bonus to [ICON_TradeRoute] Trade Routes to the city, in exchange for +2 [ICON_Gold] Gold to the Quarter, if the origin city does not have a Bakers'' Quarter.[NEWLINE][NEWLINE]At Urbanization, a supplied Café can establish services in adjacent Entertainment Complexes with Zoos and Water Parks with Ferris Wheels.'    ),

(   'en_US',    'LOC_BUILDING_CSC_BAKERS_STAGE_2_SERVICE_NAME',              'Storekeeper'     ),
(   'en_US',    'LOC_BUILDING_CSC_BAKERS_STAGE_2_SERVICE_DESCRIPTION',       'A Service established in the City Center at Feudalism when a supplied Water Mill or Wind Mill supports an adjacent Granary.[NEWLINE][NEWLINE]+10% growth and +1 [ICON_GreatEngineer] Great Engineer point from an adjacent supplied Water Mill or Wind Mill.'    ),

(   'en_US',    'LOC_BUILDING_CSC_BAKERS_STAGE_3_SERVICE_NAME',              'Innkeeper'         ),
(   'en_US',    'LOC_BUILDING_CSC_BAKERS_STAGE_3_SERVICE_DESCRIPTION',       'A Service established in the Commercial Hub at Medieval Faires when a supplied Bakery serves an adjacent Market.[NEWLINE][NEWLINE]+2 [ICON_Housing] Housing, +1 [ICON_Citizen] Citizen slot, and +1 [ICON_GreatMerchant] Great Merchant point from each adjacent supplied Bakery.'    ),

(   'en_US',    'LOC_BUILDING_CSC_BAKERS_STAGE_4_SERVICE_ENTER_NAME',              'Groundskeeper'     ),
(   'en_US',    'LOC_BUILDING_CSC_BAKERS_STAGE_4_SERVICE_ENTER_DESCRIPTION',       'A Service established in the Entertainment Complex at Urbanization when a supplied Café serves an adjacent Zoo.[NEWLINE][NEWLINE]+2 [ICON_Tourism] Tourism, +1 [ICON_Citizen] Citizen slot, and +1 [ICON_GreatEngineer] Great Engineer point from each adjacent supplied Café.'    ),

(   'en_US',    'LOC_BUILDING_CSC_BAKERS_STAGE_4_SERVICE_WATER_NAME',              'Ride Technician'     ),
(   'en_US',    'LOC_BUILDING_CSC_BAKERS_STAGE_4_SERVICE_WATER_DESCRIPTION',       'A Service established in the Water Park at Urbanization when a supplied Café serves an adjacent Ferris Wheel.[NEWLINE][NEWLINE]+2 [ICON_Tourism] Tourism, +1 [ICON_Citizen] Citizen slot, and +1 [ICON_GreatEngineer] Great Engineer point from each adjacent supplied Café.'    ),

-- EFFECT DESCRIPTIONS

(   'en_US',    'LOC_CSC_BAKERS_STAGE_2_EFFECT',    '[NEWLINE][NEWLINE]At Feudalism, a Granary adjacent to a supplied Water Mill or Wind Mill establishes a {LOC_BUILDING_CSC_BAKERS_STAGE_2_SERVICE_NAME} service: +10% growth and +1 [ICON_GreatEngineer] Great Engineer point from each adjacent supplied mill.'    ),
(   'en_US',    'LOC_CSC_BAKERS_STAGE_2_EFFECT_DESCRIPTION_WATER',    '{LOC_BUILDING_CSC_BAKERS_STAGE_2_SERVICE_NAME}: {1_iBonus}% growth and +1 [ICON_GreatEngineer] Great Engineer point.[NEWLINE]Supply Chain: supplied Water Mill [ICON_ARROW] adjacent Granary.'    ),
(   'en_US',    'LOC_CSC_BAKERS_STAGE_2_EFFECT_DESCRIPTION_WATER_NEW',    'a {LOC_BUILDING_CSC_BAKERS_STAGE_2_SERVICE_NAME} service:[NEWLINE]{1_iBonus}% growth and +1 [ICON_GreatEngineer] Great Engineer point'    ),
...
(   'en_US',    'LOC_CSC_BAKERS_STAGE_2_EFFECT_DESCRIPTION_WIND',    '{LOC_BUILDING_CSC_BAKERS_STAGE_2_SERVICE_NAME}: {1_iBonus}% growth and +1 [ICON_GreatEngineer] Great Engineer point.[NEWLINE]Supply Chain: supplied Wind Mill [ICON_ARROW] adjacent Granary.'    ),
(   'en_US',    'LOC_CSC_BAKERS_STAGE_2_EFFECT_DESCRIPTION_WIND_NEW',    'a {LOC_BUILDING_CSC_BAKERS_STAGE_2_SERVICE_NAME} service:[NEWLINE]{1_iBonus}% growth and +1 [ICON_GreatEngineer] Great Engineer point'    ),
...
(   'en_US',    'LOC_CSC_BAKERS_STAGE_2_CIVIC',    '[NEWLINE][NEWLINE]A Granary adjacent to a supplied Water Mill or Wind Mill establishes a {LOC_BUILDING_CSC_BAKERS_STAGE_2_SERVICE_NAME} service:[NEWLINE]+10% growth and +1 [ICON_GreatEngineer] Great Engineer point from an adjacent supplied mill.'    ),

(   'en_US',    'LOC_CSC_BAKERS_STAGE_3_EFFECT',    '[NEWLINE][NEWLINE]At Medieval Faires, a Market adjacent to a supplied Bakery establishes an {LOC_BUILDING_CSC_BAKERS_STAGE_3_SERVICE_NAME} service: +2 [ICON_Housing] Housing and +1 [ICON_GreatMerchant] Great Merchant point from each adjacent supplied Bakery, plus +1 [ICON_Citizen] Citizen slot in the Commercial Hub.'    ),
(   'en_US',    'LOC_CSC_BAKERS_STAGE_3_EFFECT_DESCRIPTION',    '{LOC_BUILDING_CSC_BAKERS_STAGE_3_SERVICE_NAME}: {1_iBonus} [ICON_Housing] Housing and +1 [ICON_GreatMerchant] Great Merchant point.[NEWLINE]Supply Chain: {2_StackAmount} supplied {2_Num : plural 1?Bakery; other?Bakeries;} [ICON_ARROW] adjacent Market.'    ),
(   'en_US',    'LOC_CSC_BAKERS_STAGE_3_EFFECT_DESCRIPTION_NEW',    'an {LOC_BUILDING_CSC_BAKERS_STAGE_3_SERVICE_NAME} service:[NEWLINE]{1_iBonus} [ICON_Housing] Housing, +1 [ICON_Citizen] Citizen slot in the Commercial Hub, and +1 [ICON_GreatMerchant] Great Merchant point.'    ),
...
(   'en_US',    'LOC_CSC_BAKERS_STAGE_4_EFFECT_DESCRIPTION_ENTER',    '{LOC_BUILDING_CSC_BAKERS_STAGE_4_SERVICE_ENTER_NAME}: {1_iBonus} [ICON_Tourism] Tourism and +1 [ICON_GreatEngineer] Great Engineer point.[NEWLINE]Supply Chain: {2_StackAmount} supplied {2_Num : plural 1?Café; other?Cafés;} [ICON_ARROW] adjacent Zoo.'    ),
(   'en_US',    'LOC_CSC_BAKERS_STAGE_4_EFFECT_DESCRIPTION_ENTER_NEW',    'a {LOC_BUILDING_CSC_BAKERS_STAGE_4_SERVICE_ENTER_NAME} service:[NEWLINE]{1_iBonus} [ICON_Tourism] Tourism, +1 [ICON_Citizen] Citizen slot in the Entertainment Complex, and +1 [ICON_GreatEngineer] Great Engineer point.'    ),
...
(   'en_US',    'LOC_CSC_BAKERS_STAGE_4_EFFECT_DESCRIPTION_WATER',    '{LOC_BUILDING_CSC_BAKERS_STAGE_4_SERVICE_WATER_NAME}: {1_iBonus} [ICON_Tourism] Tourism and +1 [ICON_GreatEngineer] Great Engineer point.[NEWLINE]Supply Chain: {2_StackAmount} supplied {2_Num : plural 1?Café; other?Cafés;} [ICON_ARROW] adjacent Ferris Wheel.'    ),
(   'en_US',    'LOC_CSC_BAKERS_STAGE_4_EFFECT_DESCRIPTION_WATER_NEW',    'a {LOC_BUILDING_CSC_BAKERS_STAGE_4_SERVICE_WATER_NAME} service:[NEWLINE]{1_iBonus} [ICON_Tourism] Tourism, +1 [ICON_Citizen] Citizen slot in the Water Park, and +1 [ICON_GreatEngineer] Great Engineer point.'    ),
...
(   'en_US',    'LOC_CSC_BAKERS_STAGE_4_SERVICE_ENTER',    '[NEWLINE]{LOC_BUILDING_CSC_BAKERS_STAGE_4_SERVICE_ENTER_NAME} service: +2 [ICON_Tourism] Tourism and +1 [ICON_GreatEngineer] Great Engineer point from each adjacent supplied Café, plus +1 [ICON_Citizen] Citizen slot if the district has a Zoo.'    ),
(   'en_US',    'LOC_CSC_BAKERS_STAGE_4_SERVICE_LAND',    '[NEWLINE]{LOC_BUILDING_CSC_BAKERS_STAGE_4_SERVICE_ENTER_NAME} service: +2 [ICON_Tourism] Tourism and +1 [ICON_GreatEngineer] Great Engineer point from each adjacent supplied Café, plus +1 [ICON_Citizen] Citizen slot if the district has a Zoo.'    ),
(   'en_US',    'LOC_CSC_BAKERS_STAGE_4_SERVICE_WATER',    '[NEWLINE]{LOC_BUILDING_CSC_BAKERS_STAGE_4_SERVICE_WATER_NAME} service: +2 [ICON_Tourism] Tourism and +1 [ICON_GreatEngineer] Great Engineer point from each adjacent supplied Café, plus +1 [ICON_Citizen] Citizen slot if the district has a Ferris Wheel.'    ),
(   'en_US',    'LOC_CSC_BAKERS_STAGE_4_CIVIC',    'A Zoo adjacent to a supplied Café establishes a {LOC_BUILDING_CSC_BAKERS_STAGE_4_SERVICE_ENTER_NAME} service, and a Ferris Wheel adjacent to a supplied Café establishes a {LOC_BUILDING_CSC_BAKERS_STAGE_4_SERVICE_WATER_NAME} service:[NEWLINE]+2 [ICON_Tourism] Tourism and +1 [ICON_GreatEngineer] Great Engineer point from each adjacent supplied Café, plus +1 [ICON_Citizen] Citizen slot in the district.'    ),
