...
(   'en_US',    'LOC_BUILDING_CSC_BAKERS_STAGE_4_SERVICE_ENTER_DESCRIPTION',       'A Service established in the Entertainment Complex at Urbanization when a supplied Café serves an adjacent Zoo.[NEWLINE][NEWLINE]+2 [ICON_Tourism] Tourism from each adjacent supplied Café, and +1 [ICON_Citizen] Citizen slot.'    ),

(   'en_US',    'LOC_BUILDING_CSC_BAKERS_STAGE_4_SERVICE_WATER_NAME',              'Ride Technician'     ),
(   'en_US',    'LOC_BUILDING_CSC_BAKERS_STAGE_4_SERVICE_WATER_DESCRIPTION',       'A Service established in the Water Park at Urbanization when a supplied Café serves an adjacent Ferris Wheel.[NEWLINE][NEWLINE]+2 [ICON_Tourism] Tourism from each adjacent supplied Café, and +1 [ICON_Citizen] Citizen slot.'    ),
