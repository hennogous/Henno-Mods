-- CSC_BAKERS_TEXT
-- Generated from project\localization\CSC_BAKERS_TEXT.md by project/tools/localization/loc_md_to_sql.py
...
VALUES
    ...
    ('en_US', 'LOC_BUILDING_CSC_BAKERS_STAGE_3_SERVICE_DESCRIPTION', 'A Service established in the Commercial Hub at Medieval Faires when a supplied Bakery serves an adjacent Market.[NEWLINE][NEWLINE]+2 [ICON_Housing] Housing and +1 [ICON_GreatMerchant] Great Merchant point from each adjacent supplied Bakery.'),
    ('en_US', 'LOC_BUILDING_CSC_BAKERS_STAGE_4_SERVICE_ENTER_NAME', 'Groundskeeper'),
    ('en_US', 'LOC_BUILDING_CSC_BAKERS_STAGE_4_SERVICE_ENTER_DESCRIPTION', 'A Service established in the Entertainment Complex at Urbanization when a supplied Café serves an adjacent Zoo.[NEWLINE][NEWLINE]+2 [ICON_Tourism] Tourism and +1 [ICON_GreatEngineer] Great Engineer point from each adjacent supplied Café..'),
    ('en_US', 'LOC_BUILDING_CSC_BAKERS_STAGE_4_SERVICE_WATER_NAME', 'Ride Technician'),
    ('en_US', 'LOC_BUILDING_CSC_BAKERS_STAGE_4_SERVICE_WATER_DESCRIPTION', 'A Service established in the Water Park at Urbanization when a supplied Café serves an adjacent Ferris Wheel.[NEWLINE][NEWLINE]+2 [ICON_Tourism] Tourism and +1 [ICON_GreatEngineer] Great Engineer point from each adjacent supplied Café.'),
    ...
    ('en_US', 'LOC_CSC_BAKERS_STAGE_2_EFFECT', '+1 [ICON_Food] Food from an adjacent Water Mill or Wind Mill, in exchange for +1 [ICON_Production] Production and +1 [ICON_Gold] Gold to the Water Mill or Wind Mill.[NEWLINE][NEWLINE]At Feudalism, a Granary adjacent to a supplied Water Mill or Wind Mill establishes a {LOC_BUILDING_CSC_BAKERS_STAGE_2_SERVICE_NAME} service: +10% growth and +1 [ICON_GreatEngineer] Great Engineer point from each adjacent supplied mill.'),
    ('en_US', 'LOC_CSC_BAKERS_STAGE_2_CIVIC', '[NEWLINE][NEWLINE]A Granary adjacent to a supplied Water Mill or Wind Mill establishes a {LOC_BUILDING_CSC_BAKERS_STAGE_2_SERVICE_NAME} service: +10% growth and +1 [ICON_GreatEngineer] Great Engineer point from an adjacent supplied Water Mill or Wind Mill.'),
    ...
    ('en_US', 'LOC_CSC_BAKERS_STAGE_3_CIVIC', 'A Market adjacent to a supplied Bakery establishes an {LOC_BUILDING_CSC_BAKERS_STAGE_3_SERVICE_NAME} service: +2 [ICON_Housing] Housing and +1 [ICON_GreatMerchant] Great Merchant point from each adjacent supplied Bakery, and +1 [ICON_Citizen] Citizen slot in the Commercial Hub.'),
    ...
    ('en_US', 'LOC_PEDIA_BUILDINGS_PAGE_BUILDING_CSC_BAKERS_STAGE_2_SERVICE_CHAPTER_CSCHAIN_PARA_1', 'The Water Mill or Wind Mill draws on improved Bakers'' [ICON_CSC_BASE] Base Materials nearby, turns them into dependable flour, and transports that steady flow to the city''s Granary.[NEWLINE][NEWLINE]This establishes a Storekeeper service in the City Center, ensuring that hard-earned food stores are managed for the good of the growing population.'),
    ...
    ('en_US', 'LOC_PEDIA_BUILDINGS_PAGE_BUILDING_CSC_BAKERS_STAGE_4_SERVICE_ENTER_CHAPTER_CSCHAIN_PARA_1', 'The Café draws on dependable flour from the local Water Mill or Wind Mill and improved Bakers'' [ICON_CSC_SPEC] Specialty Materials nearby, turns them into pastries and drinks, and offers that steady flow of refreshments to the growing numbers of visitors to the adjacent Zoo.[NEWLINE][NEWLINE]This gives a Citizen the opportunity to take up employment as a Groundskeeper in the Entertainment Complex, keeping paths, enclosures, and gathering places ready for visitors who now have reason to linger.'),
