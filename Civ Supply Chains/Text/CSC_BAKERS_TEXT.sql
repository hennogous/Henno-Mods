...
VALUES
    ...
    ('en_US', 'LOC_PEDIA_DISTRICTS_PAGE_DISTRICT_CSC_BAKERS_QUARTER_CHAPTER_CSCBASE_TITLE', '[ICON_CSC_BASE] Base Materials'),
    ('en_US', 'LOC_PEDIA_DISTRICTS_PAGE_DISTRICT_CSC_BAKERS_QUARTER_CHAPTER_CSCSPEC_TITLE', '[ICON_CSC_SPEC] Specialty Materials'),
    ('en_US', 'LOC_PEDIA_DISTRICTS_PAGE_DISTRICT_CSC_BAKERS_QUARTER_CHAPTER_CSCGOODS_TITLE', '[ICON_CSC_GOODS] Goods Providers'),
    ('en_US', 'LOC_PEDIA_DISTRICTS_PAGE_DISTRICT_CSC_BAKERS_QUARTER_CHAPTER_CSCSALES_TITLE', '[ICON_CSC_SALES] Sales Districts'),
