...
VALUES  (   'ICON_DISTRICT_CSC_BAKERS_QUARTER',								'ICON_ATLAS_CSC_BAKERS',				0			),
		...
		(   'ICON_BUILDING_CSC_BAKERS_STAGE_4_SERVICE_WATER',				'ICON_ATLAS_CSC_BAKERS',				10			),
		(	'ICON_BUILDING_CSC_BAKERS_STAGE_4_SERVICE_GARDEN',				'ICON_ATLAS_CSC_BAKERS',				10			),
		(	'ICON_EFFECT_CSC_BAKERS_STAGE_2',								'ICON_ATLAS_CSC_BAKERS',				12			),
		(	'ICON_EFFECT_CSC_BAKERS_STAGE_3',								'ICON_ATLAS_CSC_BAKERS',				9			),
		(	'ICON_EFFECT_CSC_BAKERS_STAGE_4',								'ICON_ATLAS_CSC_BAKERS',				14			),
		(	'ICON_BUILDING_CSC_ARISTOCRAT',									'ICON_ATLAS_CSC_BAKERS',				15			),
