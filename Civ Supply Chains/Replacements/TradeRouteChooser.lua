...
if m_TradeRouteHexPath ~= nil then
...
if m_TradeRouteCities ~= nil then
...
function AddRouteToDestinationStack(routeInfo:table)
    ...
    for yieldIndex = START_INDEX, END_INDEX do
        ...
        if destinationYields[yieldIndex] > 0 then
            if (tooltipText ~= "" and destinationYields[yieldIndex] > 0) then
                tooltipText = tooltipText .. "[NEWLINE]";
            end
            tooltipText = tooltipText .. destinationYieldTooltips[yieldIndex];
        end
