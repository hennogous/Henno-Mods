...
(   'en_US',    'LOC_BUILDING_CSC_BAKERS_STAGE_4_SERVICE_GARDEN_DESCRIPTION',       'A Service established in the Garden at Urbanization when a supplied Café serves an adjacent Conservatory, adding tourism and staffing the Garden.[NEWLINE][NEWLINE]+2 [ICON_Tourism] Tourism, +1 [ICON_Citizen] Citizen slot, and +1 [ICON_GreatArtist] Great Artist point from each adjacent supplied Café.'),
...
(   'en_US',    'LOC_CSC_BAKERS_STAGE_4_EFFECT_DESCRIPTION_GARDEN',                 '{LOC_BUILDING_CSC_BAKERS_STAGE_4_SERVICE_GARDEN_NAME}: {1_iBonus} [ICON_Tourism] Tourism and +1 [ICON_GreatArtist] Great Artist point.[NEWLINE]Supply Chain: {2_StackAmount} supplied {2_Num : plural 1?Café; other?Cafés;} [ICON_ARROW] adjacent Garden with a Conservatory.'    ),
(   'en_US',    'LOC_CSC_BAKERS_STAGE_4_EFFECT_DESCRIPTION_GARDEN_NEW',             'a {LOC_BUILDING_CSC_BAKERS_STAGE_4_SERVICE_GARDEN_NAME} service:[NEWLINE]{1_iBonus} [ICON_Tourism] Tourism, +1 [ICON_Citizen] Citizen slot in the Water Park, and +1 [ICON_GreatArtist] Great Artist point.'  ),
