...
VALUES	(	'CLASS_CSC_BAKERS_GOODS_PROVIDER',	'DISTRICT_CLASS'	),
		(	'CLASS_CSC_TAILORS_RURAL_TO_QUARTER_PRODUCTION',	'DISTRICT_CLASS'	),
...
--  CL Rural Communities provide Production to Tailors' Quarters and receive Culture in return.
INSERT OR IGNORE INTO TypeTags

		(	Type,								Tag											) VALUES
		(	'DISTRICT_RURALCOMMUNITYA',			'CLASS_CSC_TAILORS_RURAL_TO_QUARTER_PRODUCTION'	),
		(	'DISTRICT_COREX_FRONTIER_TOWN',		'CLASS_CSC_TAILORS_RURAL_TO_QUARTER_PRODUCTION'	),
		(	'DISTRICT_RURALCOMMUNITYB',			'CLASS_CSC_TAILORS_RURAL_TO_QUARTER_PRODUCTION'	),
		(	'DISTRICT_COREX_TROYU',				'CLASS_CSC_TAILORS_RURAL_TO_QUARTER_PRODUCTION'	),
		(	'DISTRICT_COREX_TSIKHE',			'CLASS_CSC_TAILORS_RURAL_TO_QUARTER_PRODUCTION'	),
		(	'DISTRICT_RURALCOMMUNITYC',			'CLASS_CSC_TAILORS_RURAL_TO_QUARTER_PRODUCTION'	),
		(	'DISTRICT_COREX_GYOSON',			'CLASS_CSC_TAILORS_RURAL_TO_QUARTER_PRODUCTION'	),
...
--  CL Urban Boroughs provide Gold to Tailors' Quarters and receive Culture in return.
INSERT OR IGNORE INTO TypeTags
