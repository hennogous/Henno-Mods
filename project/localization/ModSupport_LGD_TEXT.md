...
{LOC_BUILDING_CSC_BAKERS_STAGE_4_SERVICE_GARDEN_NAME} service: +2 [ICON_Tourism] Tourism and +1 [ICON_GreatArtist] Great Artist point from each adjacent supplied Café, plus +1 [ICON_Citizen] Citizen slot if the Garden has a Conservatory.
...
- Supply Chain: {3_TotalStackCount} supplied {3_TotalStackCount : plural 1?Café; other?Cafés;} [ICON_ARROW] adjacent Conservatory.

## LOC_CSC_BAKERS_STAGE_4_EFFECT_DESCRIPTION_GARDEN_NEW
a new {LOC_BUILDING_CSC_BAKERS_STAGE_4_SERVICE_GARDEN_NAME} service: {1_NewAmount} [ICON_Tourism] Tourism, {2_NewStack} [ICON_GreatArtist] Great Artist {3_StackCount : plural 1?point; other?points;} and +1 [ICON_Citizen] Citizen slot in the Garden

## LOC_CSC_BAKERS_STAGE_4_EFFECT_DESCRIPTION_GARDEN_INCREASED
{LOC_BUILDING_CSC_BAKERS_STAGE_4_SERVICE_GARDEN_NAME} service: {1_IncreaseAmount} [ICON_Tourism] Tourism and {2_IncreasedStack} [ICON_GreatArtist] Great Artist {3_StackCount : plural 1?point; other?points;}

## LOC_CSC_BAKERS_STAGE_4_EFFECT_DESCRIPTION_GARDEN_DECREASED
{LOC_BUILDING_CSC_BAKERS_STAGE_4_SERVICE_GARDEN_NAME} service: {1_DecreaseAmount} [ICON_Tourism] Tourism and {2_DecreasedStack} [ICON_GreatArtist] Great Artist {3_StackCount : plural 1?point; other?points;}

## LOC_CSC_BAKERS_STAGE_4_EFFECT_DESCRIPTION_GARDEN_REMOVED
...
Some visitors to the Garden also enjoy refreshments from the adjacent Café.

At Urbanization, an adjacent supplied Café can establish a {LOC_BUILDING_CSC_BAKERS_STAGE_4_SERVICE_GARDEN_NAME} service if this district has a Conservatory. See the {LOC_BUILDING_CSC_BAKERS_STAGE_4_SERVICE_GARDEN_NAME} Civilopedia page for full requirements and effects.
...
The Conservatory completes the Garden side of the Bakers' Quarter service chain, much as the Zoo and Ferris Wheel complete the Entertainment and Water Park sides.

At Urbanization, an adjacent supplied Café can establish a {LOC_BUILDING_CSC_BAKERS_STAGE_4_SERVICE_GARDEN_NAME} service in this Garden: +2 [ICON_Tourism] Tourism and +1 [ICON_GreatArtist] Great Artist point from each adjacent supplied Café, plus +1 [ICON_Citizen] Citizen slot in the district.
