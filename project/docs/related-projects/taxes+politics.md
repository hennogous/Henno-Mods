> **Documentation audit — 2026-09-12: Parked proposal.** Exploratory T&P conversation, not active CSC rules. Internal tensions remain (Governors liked by Guilds versus all-bloc penalty; differing Estate district exclusions). Preserve as input for future design reconciliation, not an accepted implementation contract.
> Classification: Related project design. See the [full audit](../DOCUMENT-AUDIT.md).
