...
> **Documentation audit — 2026-09-12: Current.** The parked Product substrate, Aristocrat and GreatWorks files exist in TaxesPolitics. Correctly separates that prototype from active CSC M&C improvement support. June runtime results remain historical evidence.
> Classification: Related project boundary. See the [full audit](../DOCUMENT-AUDIT.md).
