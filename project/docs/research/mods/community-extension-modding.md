...
> **Documentation audit — 2026-09-12: Historical.** Contains dated April FireTuner results and version-sensitive memory offsets. Installed CE/game binaries and the full external API were not revalidated. Neither the beta/version wording nor this document implies CSC currently requires CE.
> Classification: External API research. See the [full audit](../../DOCUMENT-AUDIT.md).
