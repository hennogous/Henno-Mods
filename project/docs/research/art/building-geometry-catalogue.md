...
> **Documentation audit — 2026-09-12: Historical.** Broader catalogue overlaps geometry-catalogue.md. Existing metric-defect warning is essential; raw counts are historical observations. Several analysis-data/script links are unavailable at their recorded paths. Use direct native studies for calibrated examples.
> Classification: Native asset inventory. See the [full audit](../../DOCUMENT-AUDIT.md).
...
*Blender inspection script: [`../scripts/inspect_building_mesh.py`](../../../tools/scripts/inspect_building_mesh.py)*
