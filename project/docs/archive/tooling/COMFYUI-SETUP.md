...
> **Documentation audit — 2026-09-12: Superseded.** Claims SV training is still pending; lora-training.md and checked-in training scripts describe completed/custom LoRA work. Installed models, GPU, packages and service state are an old Windows snapshot, not current inventory.
> Classification: Environment snapshot. See the [full audit](../../DOCUMENT-AUDIT.md).
