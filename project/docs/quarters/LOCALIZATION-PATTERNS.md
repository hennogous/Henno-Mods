...
> **Documentation audit — 2026-09-12: Current.** Markdown-source ownership and implementation-grounded text agree with project/localization, loc_md_to_sql.py and bakers-localization-patterns.yaml. No conflicting workflow found in the checked sources.
