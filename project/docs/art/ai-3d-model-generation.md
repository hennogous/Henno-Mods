...
- [BUILDING-SHAPES.md](../archive/art/BUILDING-SHAPES.md) for the marble rule, shape hierarchy, proportions, and exaggeration.
- [building-geometry-patterns.md](../research/art/building-geometry-patterns.md) for vanilla Civ VI mesh patterns and budgets.
