...
> **Documentation audit — 2026-09-12: Current.** Algorithm description matches the current bake helper: nearest-3D selection, UV2-connected pack islands and least-squares transforms. Family AO reuse is an intentional approximation to review per variant. July bake status is historical; no originals were rebaked.
> Classification: 3D production. See the [full audit](../DOCUMENT-AUDIT.md).
