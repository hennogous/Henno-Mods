...
Building concepts, 3D production, materials, export and art integration. Status notices in each document distinguish current guidance from material needing refresh.

[Documentation index](../README.md) · [Currency audit](../DOCUMENT-AUDIT.md)
...
- [Reusable prop library](reusable-prop-library.md) — **Current inventory and native-preserving reuse contract**.
- [Pantry plant intake](pantry-plant-intake.md) — **47 approved vegetation assets added and verified**.
...
[2D art workflows](2d/README.md) cover icons and strategic-view sprites.
