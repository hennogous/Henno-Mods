...
VALUES
    ...
    ('en_US', 'LOC_PEDIA_RESOURCES_PAGE_RESOURCE_CATTLE_CHAPTER_CSCQUAR_PARA_1', 'Base Materials:[NEWLINE][NEWLINE][ICON_BULLET] [ICON_BAKERS] Bakers'' Quarter'),
    ('en_US', 'LOC_PEDIA_RESOURCES_PAGE_RESOURCE_HONEY_CHAPTER_CSCQUAR_TITLE', 'Supply Chains'),
    ('en_US', 'LOC_PEDIA_RESOURCES_PAGE_RESOURCE_HONEY_CHAPTER_CSCQUAR_PARA_1', 'Specialty Materials:[NEWLINE][NEWLINE][ICON_BULLET] [ICON_BAKERS] Bakers'' Quarter');
