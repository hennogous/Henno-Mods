		...
		for i, pCity in playerCities:Members() do
			if pCity then
				...
				for sAttachModifier,v in pairs(tCityModifiers) do
					...
					local sString = Locale.Lookup(m_CityAttachedModifiers[sAttachModifier].Desc, iAmount, v.StackAmount);
					...
					elseif bIsStackAmountIncreased == true then
						...
						notificationData[ParameterTypes.SUMMARY] = Locale.Lookup("LOC_NOTIFICATION_HENNO_INCREASED_CITY_QUARTER_ABILITY_SUMMARY", sCityName, sIncreaseString, sMainString);
						notificationData[ParameterTypes.LOCATION] = { x = iCityX, y = iCityY };
						notificationData.AlwaysUnique = true;
						--notificationData.AutoActivate = true;
					...
					elseif bIsStackAmountDecreased == true then
						...
						notificationData[ParameterTypes.SUMMARY] = Locale.Lookup("LOC_NOTIFICATION_HENNO__CITY_QUARTER_ABILITY_SUMMARY", sCityName, sDecreaseString, sMainString);
						notificationData[ParameterTypes.LOCATION] = { x = iCityX, y = iCityY };
						notificationData.AlwaysUnique = true;
						--notificationData.AutoActivate = true;
